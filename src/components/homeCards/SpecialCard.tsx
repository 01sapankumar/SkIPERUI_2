    ...
    return (
        <div className='my-20'>
            <div className='w-[61.5%] mx-auto'>
                ...
                <h2 className='text-black/80 text-center font-bold text-6xl mt-8'>
                    Tailwind + Framer + React
                </h2>
                <h5 className='text-black/80 text-center font-bold text-3xl mb-8'>
                 ...
                 //   step4imgClass={cn(
                  ...
                  //  )}
                    image={{
                        step1light1: card4,
                        step1light2: card5,
                        step1dark1: card4, // added dark
                        step1dark2: card5, // added dark
                        step2light1: card6,
                        step2light2: card7,
                        step2dark1: card6, // added dark
                        step2dark2: card7, // added dark
                        step3light: card8,
                        step3dark: card8, // added dark
                        step4light: card8,
                       // step4dark: card8, // added dark
                        alt: "Something",
                    }}
                />
            </div>
