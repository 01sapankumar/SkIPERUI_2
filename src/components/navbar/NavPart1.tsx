...
const NavPart1 = () => {
  return (
    <div className='flex flex-wrap items-center gap-3 sm:gap-4 sm:flex-row flex-col sm:items-center'>
      <a href="https://skiper-ui.com/" className='flex items-center gap-2'>
        ...
        <p className='text-[10px] border border-orange-600 rounded-full px-1.5 text-orange-600'>Beta</p>
      </a>
